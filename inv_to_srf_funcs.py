...
def write_point_stf(fout, slip_kfault, total_time_kfault, stf_dt, rise_time_kfault, stf_type, time_pad, tinit_kfault,
                    ...
                    area_kfault, vs_kfault, density_kfault, rake_kfault, zero_slip, integrate, points_headers):
    import numpy as np
...
def write_srf(file_path, inv_or_rupt, segment_plots, stf_dt=0.1, stf_type='triangle',
    ...
    for seg in segments:
        ...
        for kfault in range(len(num_seg)):
            ...
            # print(counter2)
            counter2 += 1
            points_headers = write_point_stf(fout, slip1_kfault, total_time_kfault, stf_dt, rise_time_kfault, stf_type, time_pad,
                            tinit1_kfault, minSTFpoints, minNTstf, lon_kfault, lat_kfault, depth_kfault, strike_kfault,
                            dip_kfault, area_kfault, vs_kfault, density_kfault, rake1_kfault, zero_slip, integrate, points_headers)
            
            # print(counter2)
            counter2 += 1
            points_headers = write_point_stf(fout, slip2_kfault, total_time_kfault, stf_dt, rise_time_kfault, stf_type, time_pad,
                            tinit2_kfault, minSTFpoints, minNTstf, lon_kfault, lat_kfault, depth_kfault, strike_kfault,
                            dip_kfault, area_kfault, vs_kfault, density_kfault, rake2_kfault, zero_slip, integrate, points_headers)
            
            # print(counter2)
            counter2 += 1
            points_headers = write_point_stf(fout, slip3_kfault, total_time_kfault, stf_dt, rise_time_kfault, stf_type, time_pad,
                            tinit3_kfault, minSTFpoints, minNTstf, lon_kfault, lat_kfault, depth_kfault, strike_kfault,
                            dip_kfault, area_kfault, vs_kfault, density_kfault, rake3_kfault, zero_slip, integrate, points_headers)
            
            # print(counter2)
            counter2 += 1
            points_headers = write_point_stf(fout, slip4_kfault, total_time_kfault, stf_dt, rise_time_kfault, stf_type, time_pad,
                            tinit4_kfault, minSTFpoints, minNTstf, lon_kfault, lat_kfault, depth_kfault, strike_kfault,
                            dip_kfault, area_kfault, vs_kfault, density_kfault, rake4_kfault, zero_slip, integrate, points_headers)
            
            # print(counter2)
            counter2 += 1
            points_headers = write_point_stf(fout, slip5_kfault, total_time_kfault, stf_dt, rise_time_kfault, stf_type, time_pad,
                            tinit5_kfault, minSTFpoints, minNTstf, lon_kfault, lat_kfault, depth_kfault, strike_kfault,
                            dip_kfault, area_kfault, vs_kfault, density_kfault, rake5_kfault, zero_slip, integrate, points_headers)
            # print('Counter total: ' + str(counter2))
        
        if plane_num == 1:
            print('Finished segment 1, should have 2130 points. Actually have:')
            print(len(points_headers))
        elif plane_num == 2:
            print('Finished segment 2, should have 2510 points. Actually have:')
            print(len(points_headers))
        elif plane_num == 3:
            print('Finished segment 3, should have 2780 points. Actually have:')
            print(len(points_headers))
        elif plane_num == 4:
            print('Finished segment 4, should have 3120 points. Actually have:')
            print(len(points_headers))
